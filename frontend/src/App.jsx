...
import { Send, Bot, User, Loader2, Menu, X, BookOpen, GraduationCap, ChevronRight, MessageSquare } from 'lucide-react';
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {msg.sources.map((source, idx) => (
                            <div 
                              key={idx} 
                              className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-md text-xs font-medium text-gray-600 transition-colors cursor-help shadow-sm"
